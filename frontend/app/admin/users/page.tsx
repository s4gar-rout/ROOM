      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between mb-6">
        <div>
          ...
          <h1 className="font-serif text-[38px] font-normal leading-none tracking-[-0.03em] text-[#1C1B18]">
            User <span className="italic text-[#174D35]">accounts.</span>
          </h1>
          <p className="mt-2 text-[11px] font-medium text-[#5F554A]">Manage platform accounts, roles, and access status.</p>
        </div>

    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[#174D35]/8 text-[#174D35] border border-[#174D35]/12">
            <Trash2 size={20} strokeWidth={1.75} />
          </div>
          <button 
            onClick={onClose} 
            disabled={isLoading} 
            className="rounded-full p-1.5 text-[#756A5C] hover:bg-[#1C1B18]/5 hover:text-[#1C1B18] transition-colors cursor-pointer"
          >
            <X size={18} />
          </button>
        </div>
